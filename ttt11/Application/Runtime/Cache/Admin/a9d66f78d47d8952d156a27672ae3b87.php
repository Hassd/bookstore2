...
<div id="right" >
  ...
  <form action="/ttt11/admin.php/Book/BookDelAll" method="post" >
        ...
        <td  bgcolor="#666666"><table width="670" cellspacing="1" border="0px">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$book): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td bgcolor="#FFFFFF" style="text-align:center;">
                  <a href="/ttt11/admin.php/Book/BookSaveShow/bookid/<?php echo ($book["bookid"]); ?>">修改</a>&nbsp;
                  <a href="/ttt11/admin.php/Book/BookDel/bookid/<?php echo ($book["bookid"]); ?>">删除</a>
                </td>
