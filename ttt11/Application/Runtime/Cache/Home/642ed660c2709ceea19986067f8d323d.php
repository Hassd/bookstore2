...
<div id="header">
  <div id="login">
       ...
       <a href="dingdan.html"><img  src="/ttt/Public/Home/images/login2.gif" />我的订单</a></span> </p>
  </div>
  <div id="logo">
...
<form id="zhuce" action="/ttt/index.php/Home/Regsiter/Regsiter" method="post" style="background:url(/ttt/Public/Home/images/bg.gif) no-repeat;" onsubmit="return zczy(this)">
     <h1>天天注册</h1>
      <ul>
